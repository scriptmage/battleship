...
public class GameConfig {
    ...
    public static void parseConnectionData(String[] args) {
		...
		switch (args.length) {
		case 0:
			Application.log(String.format("Starting server on %d port", connectionData.getPortNumber()));
			break;
		case 1:
		...
		case 2:
			...
			Application.log(String.format("Connect to %s on %d port", connectionData.getHostName(), connectionData.getPortNumber()));
			break;
		default:
